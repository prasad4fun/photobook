/**
 * Sticker Element Renderer - Renders sticker images
 */
...
interface StickerElementRendererProps {
  ...
  onTransform: (attrs: Partial<StudioStickerElement>) => void;
}

export default function StickerElementRenderer({
  element,
  pageId,
  isSelected,
  onClick,
  onTransform,
}: StickerElementRendererProps) {
